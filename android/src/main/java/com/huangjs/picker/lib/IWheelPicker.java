...
public interface IWheelPicker {
   ...
   * {@link com.huangjs.picker.lib.WheelPicker.OnItemSelectedListener}回调监听或调用
   ...
   * through {@link com.huangjs.picker.lib.WheelPicker.OnItemSelectedListener} or call
   ...
   * 前所根据这些参数改变的一些属性，比如
   * {@link com.huangjs.picker.lib.WheelPicker.OnWheelChangeListener}和
   * {@link com.huangjs.picker.lib.WheelPicker.OnItemSelectedListener}监听器中方法参数的值，因
   * 此你总该在调用该方法后考虑到相关影响
   ...
   * {@link com.huangjs.picker.lib.WheelPicker.OnWheelChangeListener} and
   * {@link com.huangjs.picker.lib.WheelPicker.OnItemSelectedListener}, so you must always
   ...
   * @see com.huangjs.picker.lib.WheelPicker.OnWheelChangeListener
   */
   ...
   * 获取滚轮选择器幕布是否圆角
   * <p>
   * Get round of curtain
   * For example true
   *
   * @return 滚轮选择器幕布是否圆角
   */
  boolean isCurtainRound();

  /**
   * 设置滚轮选择器幕布是否圆角
   * <p>
   * Set round of curtain
   * For example true
   *
   * @param round 滚轮选择器幕布是否圆角
   */
  void setCurtainRound(boolean round);
